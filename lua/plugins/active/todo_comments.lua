...
return {
  ...
  config       = function(_, opts)
    ...
    vim.keymap.set("n", "tcn", function() todo_comments.jump_next() end, { desc = "Next todo comment" })
    vim.keymap.set("n", "tcp", function() todo_comments.jump_prev() end, { desc = "Previous todo comment" })
  end,
}
